...
Vector2f LevelManager::bobPosition()
{
	return m_bobPosition;
...
int** LevelManager::nextLevelSpawningPoints()
{
	...
	case 1:
		levelToLoad = "levels/level1-thomas-coins.txt";

		break;

	case 2:
		levelToLoad = "levels/level2-thomas-coins.txt";

		break;

	case 3:
		levelToLoad = "levels/level3-thomas-coins.txt";

		break;

	case 4:
		levelToLoad = "levels/level4-thomas-coins.txt";
